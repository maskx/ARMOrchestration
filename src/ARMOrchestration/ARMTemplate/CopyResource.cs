...
namespace maskx.ARMOrchestration.ARMTemplate
{
    public class CopyResource : Resource
    {
        ...
        //                    _BatchSize = (int)_Functions.Evaluate(batchSize.GetString(), FullContext);
        //            }
        //        }
